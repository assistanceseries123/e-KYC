...
def insert_records(text_info):
    ...
    with conn.session as s:
        ...
        s.execute(text("INSERT INTO users (id,name,father_name,dob,id_type,embedding) VALUES (:id,:name,:father_name,:dob,:id_type,:embedding);"),
        {
