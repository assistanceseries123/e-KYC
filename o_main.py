...
def wider_page():
    ...
    st.markdown(
        f"""
        <style>
        .reportview-container .main .block{{{max_width_str}}}
        </style>
        """,
...
def set_custom_theme():
    ...
    color: #333333; /*Set sidebar background color */
        ...
        if face_image is not None:
            ...
            if is_face_verified:
                ...
                if records.shape[0]>0:
                    ...
                    st.write(records)
                is_duplicates=check_duiplicates(text_info)
                ...
                st.error("Face Verificaqtion Failed Please try again.")
